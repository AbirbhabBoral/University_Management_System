...
public class Marks extends JFrame implements ActionListener{
    ...
    Marks(String rollno){
        ...
        JLabel heading = new JLabel("Heritage Institute of Technology");
        heading.setBounds(80,10,500,25);
        heading.setFont(new Font("Tahoma",Font.BOLD,20));
        add(heading);
        
        JLabel subheading = new JLabel("Result of Examination, Year 2023");
        subheading.setBounds(80,50,500,20);
        ...
        lblsem.setBounds(60,130,520,20);
